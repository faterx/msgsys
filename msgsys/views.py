...
def append_form(request):
    if request.method != 'POST': 
        ...
        if add_form.is_valid():
            ...
            return HttpResponseRedirect(reverse('msg_list'))
    ...
    if request.method == 'POST':
        ...
        if append_form.is_valid():  # 如果各个字段合法
            ...
            msg = Msg.objects.create(msg_type=msg_type, unit=unit, created_time=created_time,
                                     ...
                                     police_duty=police_duty, registered_police=registered_police,
                                     emergency_police=emergency_police, emergency_vehicle=emergency_vehicle,
                                     external_transfer=external_transfer, num_workers=num_workers,
                                     training_all=training_all, training_day=training_day,
                                     ...
                                     outside_prison_death=outside_prison_death, foreign_workers=foreign_workers,
